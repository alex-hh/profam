...
WANDB_MODE="offline" HYDRA_FULL_ERROR=1 srun python src/train.py experiment=main_pfam +environment=jade data.data_dir=/raid/local_scratch/$SLURM_JOB_USER/$SLURM_JOB_ID/data data.num_workers=1
