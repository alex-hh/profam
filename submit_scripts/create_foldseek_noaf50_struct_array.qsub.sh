...
python3 data_creation_scripts/create_foldseek_struct_with_af50.py $1 /SAN/orengolab/cath_plm/ProFam/data/foldseek_struct_example  --skip_af50 --num_processes 1 --minimum_foldseek_cluster_size 10 --parquet_ids $((SGE_TASK_ID - 1)) --run_foldmason
