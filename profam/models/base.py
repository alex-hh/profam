...
from profam.utils.sampling_utils import RepeatStoppingCriteria, has_too_many_repeats
...
class BaseFamilyLitModule(LightningModule):
    ...
    def _sample_seqs(
        ...
        max_total_length: Optional[int] = None,  # max length of inputs plus completions
