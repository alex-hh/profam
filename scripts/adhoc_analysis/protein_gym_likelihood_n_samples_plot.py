...
if __name__ == "__main__":
    ...
    # npz_files = glob.glob("logs/abyoeovl_openfold_fs50_ur90_memmap_251m_copied_2025-06-23_22-18/unfiltered_poet_msas_with_only_diversity_weighting_v9/*v9_lls.npz")
    save_dir = "../gym_spearman_likelihood_plots_full_gym_filtered_poet_msas_with_all_weighting_abyoeovl"
    os.makedirs(save_dir, exist_ok=True)
    target_scores = [-1.2, -1.3, -1.4, -1.5]
    for target_score in target_scores:
        ...
        for i in [1, 2, 5, 10, 20, 30, 50, 80, 120]:
