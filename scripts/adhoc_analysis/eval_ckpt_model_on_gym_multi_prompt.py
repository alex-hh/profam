...
def _generate_context_variants(
    ...
    For every possible number of context sequences that
    fits within the token budget we create *gym_subsamples_per_n* variants.  The
    ...
    **block** of *n* sequences from the full MSA until the resulting token
    ...
    for n in range(1, max_n_under_limit + 1):
        for rep in range(gym_subsamples_per_n):
