...
def calculate_coverage(alignment):
    ...
    coverage = (alignment_length * num_sequences - total_gaps) / (
        alignment_length * num_sequences
    )
    return coverage
...
logo_dir = (
    "/Users/judewells/Documents/dataScienceProgramming/cath_plm/data/ProteinGym/logos"
)
